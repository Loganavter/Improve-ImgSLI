...
APP_HIDDENIMPORTS = [
    ...
    "shared.analysis",
    "shared.analysis.background_layers",
    "shared.analysis.channel_analyzer",
    "shared.analysis.differ",
    "shared.analysis.edge_detector",
    "shared.analysis.metrics",
    "tabs.image_compare.services.analysis",
    "tabs.image_compare.services.analysis.cached_diff",
    "tabs.image_compare.services.analysis.metrics",
    "tabs.image_compare.services.analysis.runtime",
    "plugins.comparison",
