...
from tabs.image_compare.plugins.video_editor.services.keyframing.composition.defaults import (
    build_default_keyframe_adapters,
)
from tabs.image_compare.plugins.video_editor.services.keyframing.composition.registry import (
...
from tabs.image_compare.plugins.video_editor.services.timeline import (
    ChannelKeyframe,
    TimelineChannel,
    TimelineModel,
    TimelineTrack,
...
CORE_IMAGE1_TRACK_ID = "__snapshot.image1_path"
CORE_IMAGE2_TRACK_ID = "__snapshot.image2_path"
CORE_NAME1_TRACK_ID = "__snapshot.name1"
CORE_NAME2_TRACK_ID = "__snapshot.name2"
...
class KeyframedRecording:
    def __init__(
        ...
        self._core_track_ids = {
            ...
            CORE_IMAGE1_TRACK_ID,
            CORE_IMAGE2_TRACK_ID,
            CORE_NAME1_TRACK_ID,
            CORE_NAME2_TRACK_ID,
        }
    ...
    def evaluate_at(self, timestamp: float) -> FrameSnapshot:
        ...
        snapshot = FrameSnapshot(
            ...
            image1_path=self.tracks[CORE_IMAGE1_TRACK_ID].evaluate_at(clamped_time),
            image2_path=self.tracks[CORE_IMAGE2_TRACK_ID].evaluate_at(clamped_time),
            name1=self.tracks[CORE_NAME1_TRACK_ID].evaluate_at(clamped_time),
