...
from tabs.image_compare.plugins.video_editor.dialog_sections import (
...
from tabs.image_compare.plugins.video_editor.dialog_runtime import VideoEditorDialogRuntime
