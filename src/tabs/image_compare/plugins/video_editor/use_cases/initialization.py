"""Initialization use-case — thin owner owns state, logic lives here.

Pattern: docs/dev/CODE_PATTERNS.md#thin-owner-use_cases
Moved from presenter_parts/bootstrap.py so presenter stays thin.
"""
...
def initialize_editor_from_snapshots(view, editor_service, playback_engine, model) -> bool:
