...
MIN_VIDEO_EDITOR_PREVIEW_WIDTH = scaled_px(240)
MIN_VIDEO_EDITOR_PREVIEW_HEIGHT = scaled_px(135)
MIN_VIDEO_EDITOR_SETTINGS_WIDTH = scaled_px(350)
MAX_VIDEO_EDITOR_SETTINGS_WIDTH = scaled_px(650)
VIDEO_EDITOR_TOP_MARGIN_PX = scaled_px(20)
VIDEO_EDITOR_TOP_HORIZONTAL_SPACING_PX = scaled_px(10)
# ``content_layout`` around TopTabHost in ``build_settings_panel`` (12 + 12).
VIDEO_EDITOR_TABS_CONTENT_H_MARGINS_PX = scaled_px(24)
MIN_VIDEO_EDITOR_DIALOG_HEIGHT = scaled_px(600)
