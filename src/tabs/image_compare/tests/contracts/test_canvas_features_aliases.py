...
Dogma source: docs/dev/QRHI_CANVAS_FEATURES.md ("Shared code must not use
...
def get_canvas_feature_command_aliases():
    return _registry.get_feature_command_aliases()


def get_canvas_feature_command_by_alias(capability_id):
    return _registry.get_feature_command_by_alias(capability_id)
