...
from tabs.image_compare.video_editor.dialog_sections import (
    build_settings_panel,
    create_timeline_scroll_area,
    create_toolbar,
)
from tabs.image_compare.video_editor.dialog_export import VideoEditorDialogExport
from tabs.image_compare.video_editor.dialog_persistence import VideoEditorDialogPersistence
from tabs.image_compare.video_editor.dialog_runtime import VideoEditorDialogRuntime
from tabs.image_compare.video_editor.presenter import VideoEditorPresenter
...
class VideoEditorDialog(QDialog):
    ...
    def __init__(self, snapshots, export_controller, main_window_app, parent=None):
        ...
        # Must stay >= preview_label min width (480) + settings_panel min
        # width (350) + top_layout margins/spacing (30), otherwise the
        # dialog can be resized smaller than its content and the preview
        # widget ends up overlapping the settings panel.
    ...
    def update_language(self, lang_code: str):
        from tabs.image_compare.video_editor.translations import apply_translations
    ...
    def _preset_from_translated(self, translated_text):
        ...
        from tabs.image_compare.video_editor.services.export_config import CODEC_PROFILES
    ...
    def resizeEvent(self, event: QResizeEvent):
        ...
        _vplog.debug(
            "dialog_resizeEvent old=%sx%s new=%sx%s",
