...
_CONTINUOUS_CURVE_TRACK_IDS: set[str] = {
    "text.font_size",
    "text.font_weight",
    "text.alpha",
...
def register_continuous_curve_track(track_id: str) -> None:
    """Register a track ID that should interpolate with a continuous curve.

    Tab-owned adapters call this on init to declare their continuous tracks
    without the generic engine hardcoding tab-specific token names.
    """
    _CONTINUOUS_CURVE_TRACK_IDS.add(track_id)
