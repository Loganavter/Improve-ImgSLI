...
def settings_initialize(store, get_setting) -> None:
    ...
    set_default_magnifier_size(view, get_setting("magnifier_size_relative", 0.4, float))
    set_default_capture_size(view, get_setting("capture_size_relative", 0.1, float))
