...
from tabs.image_compare.canvas.features.guides.state.feature_state import GuidesWidgetState, get_guides_widget_state
    ...
    return (
        CanvasFeatureProperty(
            ...
            read_snapshot=lambda snap: {
                "value": bool(
                    get_guides_widget_state(snap.viewport_state.view_state).enabled
                )
            },
        ...
        CanvasFeatureProperty(
            ...
            read_snapshot=lambda snap: {
                "value": float(
                    get_guides_widget_state(snap.viewport_state.view_state).thickness
                )
            },
            write_snapshot=lambda snap, ch: set_snapshot_guides_state(
                snap,
        ...
        CanvasFeatureProperty(
            ...
            read_snapshot=lambda snap: {
                "r": int(
                    get_guides_widget_state(snap.viewport_state.view_state).color.r
                ),
                "g": int(
                    get_guides_widget_state(snap.viewport_state.view_state).color.g
                ),
                "b": int(
                    get_guides_widget_state(snap.viewport_state.view_state).color.b
                ),
                "a": int(
                    get_guides_widget_state(snap.viewport_state.view_state).color.a
                ),
            },
            write_snapshot=lambda snap, ch: set_snapshot_guides_state(
                snap,
