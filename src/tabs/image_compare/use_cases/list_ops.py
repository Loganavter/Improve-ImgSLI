...
def remove_specific_image_from_list(
    controller, image_number: int, index_to_remove: int
):
    controller.playlist_manager.remove_specific_image_from_list(
...
def reorder_item_in_list(
    controller, image_number: int, source_index: int, dest_index: int
):
    controller.playlist_manager.reorder_item_in_list(
        image_number, source_index, dest_index
    )
