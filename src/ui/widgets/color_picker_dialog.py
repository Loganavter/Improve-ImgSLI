...
instead of the default flat track), a hex ``CustomLineEdit``, RGB ``SpinBox``
fields and a before/after preview chip.
...
from sli_ui_toolkit.widgets import Button, CustomLineEdit, Slider, SpinBox
...
def _checkerboard_brush(is_dark: bool) -> QBrush:
    """Small tiled checkerboard used behind the alpha gradient."""
    tile = QPixmap(8, 8)
...
class _PreviewChip(QWidget):
    ...
    def paintEvent(self, _event) -> None:
        ...
        checker = _checkerboard_brush(self.theme_manager.is_dark())
        painter.setPen(Qt.PenStyle.NoPen)
...
class ColorPickerDialog(ThemedDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self._build_ui(ok_text=ok_text, cancel_text=cancel_text)
    ...
    def _apply_dialog_geometry(self) -> None:
        ...
        title_width = QFontMetrics(self.font()).horizontalAdvance(self.windowTitle()) + 88
    ...
    def _build_ui(self, *, ok_text: str, cancel_text: str) -> None:
        ...
        self._hue_slider.setMinimumHeight(140)
        ...
        self._alpha_slider.setMinimumHeight(140)
        ...
        self._hex_edit.setFixedWidth(84)
    ...
    def _paint_alpha_track(self, painter: QPainter, rect: QRectF) -> None:
        ...
        painter.setPen(Qt.PenStyle.NoPen)
        painter.setBrush(_checkerboard_brush(self.theme_manager.is_dark()))
        painter.drawRect(rect)
        gradient = QLinearGradient(rect.topLeft(), rect.bottomLeft())
    ...
    def _sync_from_color(self) -> None:
        ...
        try:
            ...
            self._hex_edit.setText(self._color.name(QColor.NameFormat.HexRgb).upper())
