...
from ui.widgets.glass_hud import GlassHUD
...
class InfoHUD(GlassHUD):
    ...
    def show_on(self, target_widget: QWidget) -> None:
    ...
    def _position(self) -> None:
        ...
        y = anchor_rect.bottom() - h - _MARGIN
        x = (
            anchor_rect.left() + _MARGIN
            if self._corner == "left"
            else anchor_rect.right() - w - _MARGIN
        )
