...
class BaseCanvasProtocol(Protocol):
    ...
    def set_layers(self, background=None, overlay=None, overlay_pos=None, coords_snapshot=None) -> None: ...
    def set_feature_overlay_content(self, pixmap, top_left) -> None: ...
    def set_overlay_coords(self, capture_center, capture_radius: float, overlay_centers: list, overlay_radius: float) -> None: ...
