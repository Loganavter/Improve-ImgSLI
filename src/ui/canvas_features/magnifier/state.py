...
class MagnifierWidgetState:
    ...
    default_divider_color: Color = field(default_factory=lambda: Color(255, 255, 255, 230))
    default_border_color: Color = field(default_factory=lambda: Color(255, 255, 255, 248))
