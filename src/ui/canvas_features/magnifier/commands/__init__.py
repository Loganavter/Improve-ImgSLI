...
def build_magnifier_commands(render_canvas_payload) -> dict[str, Any]:
    ...
    return {
        ...
        "runtime.apply_gl_overlay": apply_magnifier_gl_overlay,
        ...
        "query.active_divider_thickness": lambda store: int(
            active_or_default_divider_thickness(store.viewport.view_state)
        )
