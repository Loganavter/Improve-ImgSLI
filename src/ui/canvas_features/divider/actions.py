...
class SetDividerVisibleAction(Action):
    ...
    def __init__(self, visible: bool):
        super().__init__(type=ActionType.SET_DIVIDER_VISIBLE)
...
class SetDividerColorAction(Action):
    ...
    def __init__(self, color: Color):
        super().__init__(type=ActionType.SET_DIVIDER_COLOR)
        self.color = color
...
class SetDividerThicknessAction(Action):
    ...
    def __init__(self, thickness: int):
        super().__init__(type=ActionType.SET_DIVIDER_THICKNESS)
