...
Многие интерактивные функции приложения зависят именно от этого раздела. Если предпросмотр, лупа, имена файлов или экспорт ведут себя не так, как вы ожидаете, сначала проверьте настройки ниже.
...
- **Подсвечивать пересечения луп:** включает красную вспомогательную подсветку областей захвата, которые перекрываются другими лупами во время перетаскивания.
- **Автопокраска новых луп:** автоматически назначает каждой новой дополнительной лупе следующий цветовой набор для обводки, внутренней линии, области захвата и направляющих.
- **UI Mode:** переключает состав и сложность части элементов управления интерфейса.
