...
- В диалоге доступны настройки:
  ...
  - Формат изображения (PNG, JPEG, WEBP, JXL и др.).
...
### Запись и экспорт видео
- Используйте кнопки **Запись**, **Пауза** и **Стоп** на панели инструментов для записи ваших действий в сеансе сравнения.
- После остановки записи нажмите кнопку **Редактор видео** (иконка с видео и карандашом), чтобы открыть окно редактирования.
- В редакторе вы можете:
  - Просматривать записанные кадры.
  - Обрезать начало и конец видео с помощью ползунков на временной шкале.
  - Удалять выделенный фрагмент прямо на таймлайне клавишами `Delete` или `Backspace`.
  - Настраивать разрешение, FPS и параметры кодирования.
  - Экспортировать финальное видео в форматах MP4, WebM, AVI, GIF и др.
