...
### Несколько луп
- При добавлении дополнительных луп каждая лупа получает собственную область захвата, направляющие линии и индивидуальные цвета.
- Если включена настройка **«Автопокраска новых луп»**, новые лупы автоматически получают следующий цветовой набор, чтобы их было проще отличать друг от друга.
- Если включена настройка **«Подсвечивать пересечения луп»**, при перетаскивании области захвата приложение подсвечивает участки, которые перекрываются другими лупами.
- Эта подсветка является только вспомогательным оверлеем на холсте и не попадает в финальный рендер/экспорт.
