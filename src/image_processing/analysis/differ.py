"""
Функции для поиска различий между изображениями.

Этот модуль содержит все алгоритмы сравнения изображений:
- highlight: подсветка различий красным цветом
- grayscale: отображение различий в градациях серого
- ssim: карта структурного сходства
"""
