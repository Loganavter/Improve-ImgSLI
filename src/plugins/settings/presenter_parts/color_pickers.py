...
class SettingsColorPickerCoordinator:
    ...
    def show_magnifier_divider_color_picker(self):
        self._show_dialog(
            ...
            current_color=read_canvas_feature_color_by_setting_key(self.store.viewport, "magnifier.divider.color"),
    ...
    def apply_smart_magnifier_colors(self):
        ...
        def on_color_selected(color):
            ...
            settings_controller.set_guides_color(qcolor_to_color(QColor(color)))
