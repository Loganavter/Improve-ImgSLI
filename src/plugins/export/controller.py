...
class ExportController(QObject):
        ...
        try:
            if self.recorder.is_recording:
                ...
                if self.presenter:
                    ...
                    self.presenter.ui.btn_record.blockSignals(True)
                    self.presenter.ui.btn_record.setChecked(False)
                    self.presenter.ui.btn_record.blockSignals(False)

                    self.presenter.ui.btn_pause.setChecked(False)
                    self.presenter.ui.btn_pause.setEnabled(False)
            else:
                self.recorder.start()
                ...
                if self.presenter:
                    ...
                    self.presenter.ui.btn_record.blockSignals(True)
                    self.presenter.ui.btn_record.setChecked(True)
                    self.presenter.ui.btn_record.blockSignals(False)

                    self.presenter.ui.btn_pause.setEnabled(True)
                    self.presenter.ui.btn_pause.setChecked(False)
        finally:
            self._toggle_recording_in_progress = False
    ...
    def toggle_pause_recording(self, checked: bool = None):
        ...
        if self.presenter:
            self.presenter.ui.btn_pause.setChecked(is_paused)
