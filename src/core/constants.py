...
class AppConstants:
    ...
    MIN_MAGNIFIER_SPACING_RELATIVE_FOR_COMBINE = 0.01
    ...
    SMOOTHING_FACTOR_POS = 0.06
    SMOOTHING_FACTOR_SPACING = 0.1
    SMOOTHING_FACTOR_SPLIT = 0.1
    LERP_STOP_THRESHOLD = 0.0001
