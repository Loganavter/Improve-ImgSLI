    ...
    def set_current_image(self, image_number: int, force_refresh: bool = False, emit_signal: bool = True):
        ...
        if 0 <= current_index < len(target_list):
            ...
            if pil_img_from_list is None and new_path:
                ...
                if image_number == 1:
                    current_img = self.app_state.original_image1
                    current_path = self.app_state._image1_path
                else:
                    current_img = self.app_state.original_image2
                    current_path = self.app_state._image2_path
