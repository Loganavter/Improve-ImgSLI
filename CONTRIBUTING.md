...
Runtime deps live in `requirements-gui.txt` (PySide6, Pillow, numpy, scikit-image, imagecodecs, PyOpenGL, Markdown). Dev/test deps live in `requirements-dev.txt` (pytest, pytest-sugar, pytest-qt).
