...
Dogma source: docs/dev/CANVAS_FEATURES.md (video timeline thumbnails).
"""
...
def test_renderer_thumbnail_preserves_dynamic_width():
    from plugins.video_editor.services.thumbnails import (
...
def test_thumbnail_coordinator_prefers_timeline_viewport_indices():
    from plugins.video_editor.presenter_parts.thumbnails import ThumbnailCoordinator
