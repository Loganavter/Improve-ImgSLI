...
FEATURES_DIR = os.path.join(SRC, "ui", "canvas_features")
...
class TestAutoDiscovery:
    ...
    def test_template_excluded_from_scene_features(self):
        from ui.canvas_infra.scene.feature_registry import get_canvas_scene_features

        get_canvas_scene_features.cache_clear()
...
class TestFeatureContracts:
    ...
    def test_all_widget_features_have_name(self):
        ...
        get_canvas_widget_features.cache_clear()
        for f in get_canvas_widget_features():
