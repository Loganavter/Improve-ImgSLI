"""Settings controller: applying font settings batches store writes and
captures undo state once, skipping the capture when nothing changed.

Dogma source: docs/dev/ARCHITECTURE.md §State Model (batched dispatch).
"""
