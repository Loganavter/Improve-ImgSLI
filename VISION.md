...
Today, I view Improve ImgSLI as a valuable public asset. ~~Today, I view Improve ImgSLI as a valuable public asset, much like [VideoCut](https://github.com/kanehekili/VideoCut) Kanehekili, another tool whose principles partially guided its development and which has become indispensable in my own workflow.~~ We are now moving towards becoming a full-scale "media comparison factory" rather than just a simple utility. The vision for the future includes a robust system of tabs and project management to handle complex workflows.
...
It's difficult to pinpoint the exact time spent on the project, but I would estimate it to be approximately 500 hours in total, excluding the time required for package construction.
