...
Run from repo root:
    ...
    python3 scripts/compile_shaders.py            # compile everything
    python3 scripts/compile_shaders.py --check    # exit non-zero if any .qsb is stale
    python3 scripts/compile_shaders.py --clean    # remove .qsb files and exit
