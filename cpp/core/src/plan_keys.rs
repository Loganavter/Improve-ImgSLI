...
//!    clip.
//!
//! Feature-coupled plan building (overlay layout, virtual canvas, snapshot
//! store construction) stays in Python until C++ feature contracts land
//! (Phase 1B / Phase 3 — see `docs/dev/CPP_RUST_MIGRATION.md`).
